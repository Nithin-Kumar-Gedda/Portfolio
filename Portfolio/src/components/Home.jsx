	...
	return (
		<div className='area relative z-0 bg-black w-screen h-screen'>
			...
			<div className='hero relative h-[calc(100vh)] flex justify-center items-center text-white' id='hero'>
				<div className='flex flex-col items-center justify-center pt-4 h-36 backdrop-blur-sm rounded-3xl'>
					<h1 className='text-6xl sm:text-7xl font-extrabold mt-2'>Hi, I'm&nbsp;<span className='text-yellow-200 font-extrabold'>{text}</span></h1>
					<p className='mt-3 text-xl'>I'm passionate about creating scalable AI solutions that optimize decision-making and performance.</p>
				</div>      
			</div>
			<Footer/>
		</div>	
